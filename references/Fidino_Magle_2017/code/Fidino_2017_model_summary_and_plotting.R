...
# read in observed data
z <- df_2_array(read.table("Fidino_2017_community_incidence_matrix_sp10_sp13.txt", header = TRUE, sep = "\t"))[2,,]
...
# read in observed data
z <- df_2_array(read.table("Fidino_2017_community_incidence_matrix_sp10_sp13.txt", header = TRUE, sep = "\t"))[3,,]
...
# read in observed data
z <- df_2_array(read.table("Fidino_2017_community_incidence_matrix_sp10_sp13.txt", header = TRUE, sep = "\t"))[4,,]
...
# read in observed data
z <- df_2_array(read.table("Fidino_2017_community_incidence_matrix_sp10_sp13.txt", header = TRUE, sep = "\t"))[5,,]
...
for(pup in 1:1){
tiff("all_col3.tiff", height = 14, width = 12, units = "in",
...
layout(m)
par( mar = c(2,2.5, 1.25,0.5),
     oma = c(2,2.5,1.25,0.5) + 0.1)
...
for(i in 1:5){
  ...
  se <- c("SU", "FA", "WI", "SP")
  mtext("Year:", 1, line = 0.85, at = 0.18, cex = 0.75)
  mtext("Season:", 1, line = 1.85, at = 0, cex = 0.75)
  mtext(text = c("'11", "'12", "'13"), 1, line = 0.9, at = c(1,4,8), cex = 0.75)
  mtext(text = rep(se, 2),1, line = 1.9, at = c(1:8), cex = 0.75)
  ...
  points(1:8, observed_colonization[i,], pch = 21, bg = "white", col = "black", cex = 1.25)
  for(j in 1:8){
    lines(c(j,j), zest_PTM[-2,j,i], lwd = 1.25)
  }
  points(zest_PTM[2,,i], pch = 21, bg = "black",col = "black", cex = 1.25)
}
...
for(i in 1:5){
  ...
  points(zest_STM[2,,i], pch = 21, bg = "black",col = "black", cex = 1.25)
}
...
for(i in 1:5){
  ...
  points(zest_HTM[2,,i], pch = 21, bg = "black",col = "black", cex = 1.25)
}
dev.off()
}
